...
public class BlogRepository {
	...
	public boolean updateInfo(BlogVo vo) {
		return sqlSession.update("blog.updateInfo",vo)==1;
	}

	public boolean updateImg(BlogVo vo) {
		return sqlSession.update("blog.updateImg",vo)==1;
	}
}
